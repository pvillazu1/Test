...
public class PostAdTests extends BaseTest {
	...
	private NavigationPage navpage;
	  ...
	  @Test
	  public void testTc07PostAdPageDisplayedCorrectly() {
		  homepage.clickLogIn().logIn("pvillazu", "PpVv135#").verifyLoads();
		  Assert.assertTrue(navpage.clickPost().verifyLoads()); 
	  }
	  
	  @Test
	  public void testTc08LogInPageDisplayedWhenUserNotLogged() {
		  navpage.clickPost();
